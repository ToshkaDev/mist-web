const fieldMap = new Map<string, string>([
    ...
    ["NEIGHBOUR_GENES",""],
    ["GENE","stable_id,version,start,stop,names,locus,old_locus,location,product,strand,length,cds_qualifiers,pseudo&fields.Component=version,definition&fields.Component.Genome=version"],
    ["DOMAINS",""],
]);
